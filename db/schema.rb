...
ActiveRecord::Schema[7.0].define(version: 20_230_212_224_030) do
  ...
  create_table 'dish_ingredients', force: :cascade do |t|
    ...
    t.index %w[dish_id ingredient_id], name: 'index_dish_ingredients_on_dish_id_and_ingredient_id', unique: true
  ...
  create_table 'orders', force: :cascade do |t|
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.text 'excluded_ingredients', default: [], array: true
  end
end
